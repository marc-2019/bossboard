...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'PROXY_ERROR', message: 'Failed to fetch invoice' },
      { status: 502 },
    );
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'PROXY_ERROR', message: 'Failed to update invoice' },
      { status: 502 },
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'PROXY_ERROR', message: 'Failed to delete invoice' },
      { status: 502 },
    );
  }
}
