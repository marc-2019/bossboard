...
/** YYYY-MM-DD, today + 30 days (default quote validity). */
...
export default function NewQuotePage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const cleanedItems: CreateQuoteInput['lineItems'] = [];
    ...
    setSubmitting(true);
    try {
      const data = await quotesClient.create(payload);
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <p className="text-xs text-gray-500">
          ...
          Settings — they&apos;ll be added to the quote automatically.
        </p>
      </form>
    </div>
  );
